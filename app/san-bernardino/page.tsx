...
const sanBernardinoHomes = [
  { title: "Mountain View Residences", description: "Senior care homes with scenic mountain views offering peaceful, comfortable living with personalized attention." },
  { title: "Full-Service Care Communities", description: "Comprehensive assisted living with 24/7 support, modern amenities, and engaging daily programs." },
  { title: "Memory Care Centers", description: "Specialized care environments for seniors with Alzheimer's or dementia, featuring trained staff and secure settings." },
  { title: "Independent Living Options", description: "For active seniors seeking minimal assistance while enjoying community amenities and social opportunities." },
];

const sanBernardinoServices = [
...
const whyChooseSanBernardino = [
  "Affordable senior care in San Bernardino County",
  "Multiple care levels to match changing needs",
  "Experienced, compassionate caregiving staff",
  "Strong relationships with local hospitals",
  "Mountain and valley settings available",
  "Family-focused care philosophy",
];

const sanBernardinoTestimonials = [
  { quote: "The affordability and quality of care we found in San Bernardino exceeded our expectations. Highly recommend.", name: "Angela R.", relation: "Daughter of San Bernardino Resident" },
  { quote: "Staff members treat residents with genuine respect and compassion. We're grateful we found this community.", name: "Thomas B.", relation: "Son of Resident" },
  { quote: "From the first call to move-in day, the process was smooth and supportive. Outstanding service.", name: "Jennifer M.", relation: "San Bernardino Family Member" }
];

const sanBernardinoFaqs = [
  { q: "What senior care options exist in San Bernardino?", a: "San Bernardino offers various options including residential care homes, assisted living communities, and specialized memory care facilities through our network." },
  { q: "Is San Bernardino an affordable option for senior care?", a: "Yes, San Bernardino offers some of the most affordable quality senior care in Southern California while maintaining excellent care standards." },
  { q: "Do you have memory care facilities in San Bernardino?", a: "Yes, several of our partner homes specialize in memory care with secure environments and dementia-trained staff members." },
  { q: "How do I find the right care home in San Bernardino?", a: "Contact us for a free consultation. We'll assess needs, discuss preferences, and arrange tours at matching facilities." },
  { q: "Can care be adjusted as needs change?", a: "Absolutely. Our San Bernardino network allows seamless transitions between care levels as your loved one's needs evolve." },
  { q: "Can I tour facilities before deciding?", a: "Yes! We strongly encourage tours. Schedule a Free Tour or Call Now to get started." },
];
    ...
    <div className="flex flex-col min-h-screen bg-white text-gray-700 overflow-x-hidden antialiased">
              ...
              <div className="relative group">
                ...
                <div className="absolute left-1/2 -translate-x-1/2 mt-7 w-[560px] bg-white rounded-md shadow-lg pt-4 pb-3 px-5 z-20 hidden group-hover:block ring-1 ring-black ring-opacity-5 before:content-[''] before:absolute before:top-[-28px] before:left-0 before:right-0 before:h-[28px]">
                  <div className="grid grid-cols-3 gap-x-6 gap-y-1">
                    ...
                    <Link href="/san-bernardino" className="block whitespace-nowrap px-3 py-2 text-sm text-[#CD7B00] bg-gray-50 rounded">San Bernardino</Link>
      ...
      <section className="relative min-h-[60vh] md:min-h-[500px] flex items-center justify-center text-center overflow-hidden bg-gray-900">
        <div className="absolute inset-0">
          <Image src="/sanbernardinohero.webp" alt="San Bernardino Mountains and cityscape" fill style={{ objectFit: 'cover' }} className="w-full h-full object-cover opacity-50" priority />
          <div className="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-black/10"></div>
        </div>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-20 md:py-28">
          <Badge className="bg-white/10 border border-white/20 text-white backdrop-blur-sm mb-4 px-3 py-1 font-medium tracking-wide text-sm rounded-full">Assisted Living in San Bernardino, CA</Badge>
          <h1 className="text-4xl md:text-5xl lg:text-5xl font-bold mb-4 leading-tight text-white [text-shadow:_0_1px_3px_rgb(0_0_0_/_50%)]">
            Compassionate & Affordable Senior Care in San Bernardino
          </h1>
          <p className="text-lg md:text-xl text-white/95 leading-relaxed max-w-2xl mx-auto mb-8 [text-shadow:_0_1px_2px_rgb(0_0_0_/_40%)]">
            Discover quality assisted living in San Bernardino with mountain views and caring communities. We help families find affordable, dignified care for their loved ones.
          </p>
      ...
      <section className="py-24 md:py-32 bg-white">
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-3 gap-12 md:gap-16 items-center">
          <div className="md:col-span-2">
            <Badge className="bg-[#CD7B00]/10 text-[#B56D00] border border-[#CD7B00]/20 mb-4 px-4 py-1 font-medium tracking-wide text-sm rounded-full">San Bernardino Senior Living</Badge>
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 tracking-tight">Quality Assisted Living Services in San Bernardino, California</h2>
            <p className="text-lg text-gray-600 mb-6 leading-relaxed">San Bernardino, nestled at the foot of the San Bernardino Mountains, offers seniors a unique combination of natural beauty and accessible healthcare. Our network of licensed care homes provides affordable, high-quality care in comfortable residential settings.</p>
            <p className="text-lg text-gray-600 mb-8 leading-relaxed">From basic daily assistance to specialized memory care, our San Bernardino communities offer personalized care plans that respect each resident's individual needs and preferences.</p>
            <h3 className="text-xl font-semibold text-gray-800 mb-4">Why Choose San Bernardino:</h3>
            <div className="grid sm:grid-cols-2 gap-x-6 gap-y-2 text-gray-600 mb-8 text-sm">
              <ul className="space-y-2">
                ...
                <li className="flex items-start"><CheckCircle2 className="h-4 w-4 text-[#CD7B00]/80 mr-2 mt-0.5 flex-shrink-0" /> Mountain and valley settings</li>
                ...
                <li className="flex items-start"><CheckCircle2 className="h-4 w-4 text-[#CD7B00]/80 mr-2 mt-0.5 flex-shrink-0" /> Home-cooked meals daily</li>
              </ul>
              <ul className="space-y-2">
                ...
                <li className="flex items-start"><CheckCircle2 className="h-4 w-4 text-[#CD7B00]/80 mr-2 mt-0.5 flex-shrink-0" /> Social activities and outings</li>
                <li className="flex items-start"><CheckCircle2 className="h-4 w-4 text-[#CD7B00]/80 mr-2 mt-0.5 flex-shrink-0" /> Close to major hospitals</li>
              </ul>
            </div>
            <Card className="bg-[#FDF8F2]/60 p-6 border border-gray-100/80 rounded-lg shadow-sm">
              <blockquote className="text-gray-700 italic text-center md:text-left">"The affordability and quality of care we found in San Bernardino exceeded our expectations."<cite className="block text-sm text-gray-500 not-italic mt-2">— Angela R., Daughter of San Bernardino Resident</cite></blockquote>
            </Card>
          </div>
          <div className="relative w-full h-80 md:h-[450px] rounded-xl overflow-hidden shadow-xl border border-gray-100/80">
            <Image src="/sanbernardinopersonalizedcare.webp" alt="San Bernardino senior care community" fill style={{ objectFit: 'cover' }} className="transition-transform duration-500 hover:scale-105" />
          </div>
        </div>
      </section>
      ...
      <section id="homes" className="py-24 md:py-32 bg-[#FDF8F2]/50 border-y border-gray-100/80">
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <Badge className="bg-white border border-[#CD7B00]/20 text-[#B56D00] mb-6 px-4 py-1 font-medium tracking-wide text-sm rounded-full">San Bernardino Options</Badge>
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-5 tracking-tight">Senior Care Communities in San Bernardino</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">Explore our selection of quality care homes in San Bernardino County, each offering unique environments and care services.</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            {sanBernardinoHomes.map((home) => (
      ...
      <section id="team" className="py-24 md:py-32 bg-white">
        <div className="max-w-screen-lg mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-5 text-gray-900 tracking-tight">Your San Bernardino Care Advisors</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">Our experienced team guides San Bernardino families through the senior care journey with expertise and compassion.</p>
          </div>
      ...
      <section id="services" className="py-24 md:py-32 bg-[#FDF8F2]/50 border-t border-gray-100/80">
        <div className="max-w-screen-lg mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-12 md:gap-16 items-center">
          <div className="relative w-full h-80 md:h-96 rounded-xl overflow-hidden shadow-xl border border-gray-100/80 order-last md:order-first">
            <Image src="/sanbernardinoourservices.webp" alt="Senior care services in San Bernardino" fill style={{ objectFit: 'cover' }} className="transition-transform duration-500 hover:scale-105" />
          </div>
          <div>
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 tracking-tight">Senior Care Services in San Bernardino</h2>
            <p className="text-lg text-gray-600 mb-8 leading-relaxed">Our San Bernardino care homes provide comprehensive services tailored to each resident's needs, promoting independence while ensuring safety.</p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-2 text-gray-600 mb-8 text-sm">
              {sanBernardinoServices.map(service => (<div key={service} className="flex items-start"><CheckCircle2 className="h-4 w-4 text-[#CD7B00]/80 mr-2 mt-0.5 flex-shrink-0" />{service}</div>))}
            </div>
            <Button asChild size="lg" className="bg-[#CD7B00] hover:bg-[#B56D00] text-white shadow-md hover:shadow-lg transition-shadow duration-300 px-7 py-3 text-base rounded-md">
      ...
      <section id="why-us" className="py-24 md:py-32 bg-white border-b border-gray-100/80">
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <Badge className="bg-[#CD7B00]/10 text-[#B56D00] border border-[#CD7B00]/20 mb-6 px-4 py-1 font-medium tracking-wide text-sm rounded-full">Why San Bernardino</Badge>
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-5 tracking-tight">San Bernardino's Trusted Senior Care Partner</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">Families throughout San Bernardino County trust us for affordable, quality senior care solutions.</p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {whyChooseSanBernardino.map((reason, index) => (
      ...
      <section id="testimonials" className="relative py-24 md:py-32 border-b border-gray-100/80 bg-cover bg-center bg-no-repeat" style={{ backgroundImage: "url('/sanbernardinotestimonials.webp')" }}>
        ...
        <div className="relative z-10 max-w-screen-lg mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-5 tracking-tight">What San Bernardino Families Say</h2>
          </div>
          <div className="grid md:grid-cols-1 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {sanBernardinoTestimonials.map((item, index) => (
      ...
      <section id="faq" className="py-24 md:py-32 bg-white border-b border-gray-100/80">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-5 tracking-tight">San Bernardino Senior Care FAQs</h2>
            <p className="text-lg text-gray-600 leading-relaxed">Common questions about assisted living in San Bernardino, California.</p>
          </div>
          <Accordion type="single" collapsible className="space-y-4">
            {sanBernardinoFaqs.map((faq, index) => (
      ...
      <section id="contact" className="py-24 md:py-32 bg-[#FDF8F2]/50 border-b border-gray-100/80">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 tracking-tight">Find Affordable Senior Care in San Bernardino</h2>
          <p className="text-lg text-gray-600 mb-10 leading-relaxed max-w-2xl mx-auto">Ready to explore senior care options in San Bernardino? Contact us today for a free consultation and personalized recommendations.</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button asChild size="lg" className="bg-[#CD7B00] hover:bg-[#B56D00] text-white shadow-md hover:shadow-lg transition-shadow duration-300 px-7 py-3 text-base rounded-md">
              <a href="tel:951-299-9962"><Phone className="mr-2 h-5 w-5" /> Call (951) 299-9962</a>
            </Button>
        ...
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16">
            <div className="lg:col-span-2 space-y-5">
              ...
              <div className="flex items-start gap-2 text-gray-400 text-sm"><MapPin className="h-4 w-4 text-[#CD7B00] mt-0.5 flex-shrink-0" /><span>Serving San Bernardino, Fontana, Rialto & San Bernardino County</span></div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-8 text-sm">
                <div>
                  ...
                  <ul className="space-y-2 leading-relaxed">
                    <li><Link href="/san-bernardino" className="text-[#CD7B00] font-medium hover:text-white">San Bernardino</Link></li>
                    <li><Link href="/fontana" className="hover:text-white">Fontana</Link></li>
                    <li><Link href="/rialto" className="hover:text-white">Rialto</Link></li>
                    <li><Link href="/ontario" className="hover:text-white">Ontario</Link></li>
                  </ul>
                </div>
                <div>
          ...
          <div className="border-t border-gray-700 mt-16 pt-10">
            ...
            <div className="text-center text-xs text-gray-500"><p>© {new Date().getFullYear()} Senior Care Authority - San Bernardino. All rights reserved.</p></div>
          </div>
        </div>
      </footer>
    </div>
