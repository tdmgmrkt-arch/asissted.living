...
const menifeeHomes = [
  { title: "Valley View Homes", description: "Serene residential care homes in Menifee's peaceful neighborhoods with personalized attention and comfortable living." },
  { title: "Full-Service Communities", description: "Comprehensive assisted living with professional staff, modern amenities, and enriching daily activities." },
  { title: "Memory Care Homes", description: "Specialized environments for seniors with Alzheimer's or dementia, featuring trained caregivers and secure settings." },
  { title: "Active Senior Living", description: "For independent seniors wanting light support while enjoying Menifee's relaxed lifestyle and community." },
];

const menifeeServices = [
  "Personal care and daily living assistance",
  "Medication management and monitoring",
  "Three home-cooked meals plus snacks",
  "Housekeeping and laundry services",
  "Transportation to appointments and activities",
  "Social programs and wellness activities",
];

const whyChooseMenifee = [
  "Growing community with excellent senior care options",
  "Peaceful suburban environment for relaxed living",
  "Personalized care with attentive staff ratios",
  "Convenient location between Murrieta and Perris",
  "New, modern facilities alongside established homes",
  "Family-oriented community atmosphere",
];

const menifeeTestimonials = [
  { quote: "Menifee was the perfect choice for mom. The quiet neighborhood and caring staff have made such a difference in her quality of life.", name: "Chris D.", relation: "Son of Menifee Resident" },
  { quote: "We love how peaceful and safe the community feels. The caregivers treat everyone like family.", name: "Nancy L.", relation: "Daughter of Resident" },
  { quote: "The transition was seamless thanks to the supportive team. Dad has made new friends and is happier than we've seen in years.", name: "Mark S.", relation: "Menifee Family Member" }
];

const menifeeFaqs = [
  { q: "What senior care options are available in Menifee?", a: "Menifee offers various options through our network including residential care homes, assisted living communities, and memory care facilities." },
  { q: "Is Menifee a good location for senior care?", a: "Yes, Menifee's quiet, suburban environment provides an ideal setting for senior care with easy access to healthcare and family-friendly neighborhoods." },
  { q: "Do you offer memory care in Menifee?", a: "Yes, several of our partner homes in Menifee specialize in memory care with secure environments and trained staff." },
  { q: "How do I find the right Menifee care home?", a: "Contact us for a free consultation. We'll discuss your loved one's needs and arrange tours at homes that match your requirements." },
  { q: "Can care plans change over time?", a: "Absolutely. Our Menifee network provides flexibility to adjust care as your loved one's needs evolve." },
  { q: "Are tours available?", a: "Yes! We encourage families to visit homes before deciding. Schedule a Free Tour or Call Now." },
];
    ...
    <div className="flex flex-col min-h-screen bg-white text-gray-700 overflow-x-hidden antialiased">
              ...
              <div className="relative group">
                ...
                <div className="absolute left-1/2 -translate-x-1/2 mt-7 w-[560px] bg-white rounded-md shadow-lg pt-4 pb-3 px-5 z-20 hidden group-hover:block ring-1 ring-black ring-opacity-5 before:content-[''] before:absolute before:top-[-28px] before:left-0 before:right-0 before:h-[28px]">
                  <div className="grid grid-cols-3 gap-x-6 gap-y-1">
                    ...
                    <Link href="/menifee" className="block whitespace-nowrap px-3 py-2 text-sm text-[#CD7B00] bg-gray-50 rounded">Menifee</Link>
      ...
      <section className="relative min-h-[60vh] md:min-h-[500px] flex items-center justify-center text-center overflow-hidden bg-gray-900">
        <div className="absolute inset-0">
          <Image src="/menifeehero.webp" alt="Menifee California suburban landscape" fill style={{ objectFit: 'cover' }} className="w-full h-full object-cover opacity-50" priority />
          <div className="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-black/10"></div>
        </div>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-20 md:py-28">
          <Badge className="bg-white/10 border border-white/20 text-white backdrop-blur-sm mb-4 px-3 py-1 font-medium tracking-wide text-sm rounded-full">Assisted Living in Menifee, CA</Badge>
          <h1 className="text-4xl md:text-5xl lg:text-5xl font-bold mb-4 leading-tight text-white [text-shadow:_0_1px_3px_rgb(0_0_0_/_50%)]">
            Peaceful Senior Living in Menifee's Growing Community
          </h1>
          <p className="text-lg md:text-xl text-white/95 leading-relaxed max-w-2xl mx-auto mb-8 [text-shadow:_0_1px_2px_rgb(0_0_0_/_40%)]">
            Discover quality assisted living in Menifee's tranquil suburban setting. Our network of care homes provides personalized support in a peaceful, family-friendly environment.
          </p>
      ...
      <section className="py-24 md:py-32 bg-white">
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-3 gap-12 md:gap-16 items-center">
          <div className="md:col-span-2">
            <Badge className="bg-[#CD7B00]/10 text-[#B56D00] border border-[#CD7B00]/20 mb-4 px-4 py-1 font-medium tracking-wide text-sm rounded-full">Menifee Senior Living</Badge>
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 tracking-tight">Quality Assisted Living Services in Menifee, California</h2>
            <p className="text-lg text-gray-600 mb-6 leading-relaxed">Menifee has grown into one of Riverside County's most desirable communities, offering seniors a peaceful suburban environment with excellent amenities. Our network of licensed care homes provides compassionate, personalized care in this welcoming community.</p>
            <p className="text-lg text-gray-600 mb-8 leading-relaxed">Whether your loved one needs basic daily assistance or specialized memory care, our Menifee communities deliver tailored care plans that honor each resident's independence and dignity.</p>
            <h3 className="text-xl font-semibold text-gray-800 mb-4">Why Families Choose Menifee:</h3>
            <div className="grid sm:grid-cols-2 gap-x-6 gap-y-2 text-gray-600 mb-8 text-sm">
              <ul className="space-y-2">
                <li className="flex items-start"><CheckCircle2 className="h-4 w-4 text-[#CD7B00]/80 mr-2 mt-0.5 flex-shrink-0" /> Quiet suburban neighborhoods</li>
                <li className="flex items-start"><CheckCircle2 className="h-4 w-4 text-[#CD7B00]/80 mr-2 mt-0.5 flex-shrink-0" /> Modern care facilities</li>
                ...
                <li className="flex items-start"><CheckCircle2 className="h-4 w-4 text-[#CD7B00]/80 mr-2 mt-0.5 flex-shrink-0" /> Fresh, home-cooked meals</li>
              </ul>
              <ul className="space-y-2">
                ...
                <li className="flex items-start"><CheckCircle2 className="h-4 w-4 text-[#CD7B00]/80 mr-2 mt-0.5 flex-shrink-0" /> Convenient central location</li>
              </ul>
            </div>
            <Card className="bg-[#FDF8F2]/60 p-6 border border-gray-100/80 rounded-lg shadow-sm">
              <blockquote className="text-gray-700 italic text-center md:text-left">"Menifee was the perfect choice for mom. The quiet neighborhood and caring staff have made such a difference."<cite className="block text-sm text-gray-500 not-italic mt-2">— Chris D., Son of Menifee Resident</cite></blockquote>
            </Card>
          </div>
          <div className="relative w-full h-80 md:h-[450px] rounded-xl overflow-hidden shadow-xl border border-gray-100/80">
            <Image src="/menifeepersonalizedcare.webp" alt="Menifee assisted living community" fill style={{ objectFit: 'cover' }} className="transition-transform duration-500 hover:scale-105" />
          </div>
        </div>
      </section>
      ...
      <section id="homes" className="py-24 md:py-32 bg-[#FDF8F2]/50 border-y border-gray-100/80">
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <Badge className="bg-white border border-[#CD7B00]/20 text-[#B56D00] mb-6 px-4 py-1 font-medium tracking-wide text-sm rounded-full">Menifee Care Options</Badge>
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-5 tracking-tight">Senior Living Communities in Menifee</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">Explore our network of quality care homes in Menifee, each offering unique environments and personalized care.</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            {menifeeHomes.map((home) => (
      ...
      <section id="team" className="py-24 md:py-32 bg-white">
        <div className="max-w-screen-lg mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-5 text-gray-900 tracking-tight">Your Menifee Senior Care Team</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">Our dedicated team helps Menifee families find the ideal senior care solution.</p>
          </div>
      ...
      <section id="services" className="py-24 md:py-32 bg-[#FDF8F2]/50 border-t border-gray-100/80">
        <div className="max-w-screen-lg mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-12 md:gap-16 items-center">
          <div className="relative w-full h-80 md:h-96 rounded-xl overflow-hidden shadow-xl border border-gray-100/80 order-last md:order-first">
            <Image src="/menifeeourservices.webp" alt="Senior care services in Menifee" fill style={{ objectFit: 'cover' }} className="transition-transform duration-500 hover:scale-105" />
          </div>
          <div>
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 tracking-tight">Senior Care Services in Menifee</h2>
            <p className="text-lg text-gray-600 mb-8 leading-relaxed">Our Menifee care homes provide comprehensive services designed around each resident's unique needs.</p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-2 text-gray-600 mb-8 text-sm">
              {menifeeServices.map(service => (<div key={service} className="flex items-start"><CheckCircle2 className="h-4 w-4 text-[#CD7B00]/80 mr-2 mt-0.5 flex-shrink-0" />{service}</div>))}
            </div>
            <Button asChild size="lg" className="bg-[#CD7B00] hover:bg-[#B56D00] text-white shadow-md hover:shadow-lg transition-shadow duration-300 px-7 py-3 text-base rounded-md">
              <a href="tel:951-299-9962"><Phone className="mr-2 h-5 w-5" /> Discuss Care Options</a>
            </Button>
          </div>
        </div>
      </section>
      ...
      <section id="why-us" className="py-24 md:py-32 bg-white border-b border-gray-100/80">
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <Badge className="bg-[#CD7B00]/10 text-[#B56D00] border border-[#CD7B00]/20 mb-6 px-4 py-1 font-medium tracking-wide text-sm rounded-full">Why Choose Menifee</Badge>
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-5 tracking-tight">Menifee's Trusted Senior Care Provider</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">Families throughout Menifee and surrounding areas trust us for quality, compassionate senior care.</p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {whyChooseMenifee.map((reason, index) => (
      ...
      <section id="testimonials" className="relative py-24 md:py-32 border-b border-gray-100/80 bg-cover bg-center bg-no-repeat" style={{ backgroundImage: "url('/menifeetestimonials.webp')" }}>
        ...
        <div className="relative z-10 max-w-screen-lg mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-5 tracking-tight">What Menifee Families Say</h2>
          </div>
          <div className="grid md:grid-cols-1 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {menifeeTestimonials.map((item, index) => (
      ...
      <section id="faq" className="py-24 md:py-32 bg-white border-b border-gray-100/80">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-5 tracking-tight">Menifee Senior Care Questions</h2>
            <p className="text-lg text-gray-600 leading-relaxed">Common questions about assisted living in Menifee, California.</p>
          </div>
          <Accordion type="single" collapsible className="space-y-4">
            {menifeeFaqs.map((faq, index) => (
      ...
      <section id="contact" className="py-24 md:py-32 bg-[#FDF8F2]/50 border-b border-gray-100/80">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 tracking-tight">Find Quality Senior Care in Menifee Today</h2>
          <p className="text-lg text-gray-600 mb-10 leading-relaxed max-w-2xl mx-auto">Ready to explore assisted living options in Menifee? Contact us for a free consultation and let us help find the perfect fit.</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button asChild size="lg" className="bg-[#CD7B00] hover:bg-[#B56D00] text-white shadow-md hover:shadow-lg transition-shadow duration-300 px-7 py-3 text-base rounded-md">
              <a href="tel:951-299-9962"><Phone className="mr-2 h-5 w-5" /> Call (951) 299-9962</a>
            </Button>
        ...
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16">
            <div className="lg:col-span-2 space-y-5">
              ...
              <div className="flex items-start gap-2 text-gray-400 text-sm"><MapPin className="h-4 w-4 text-[#CD7B00] mt-0.5 flex-shrink-0" /><span>Serving Menifee, Sun City, Perris & Southwest Riverside County</span></div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-8 text-sm">
                <div>
                  ...
                  <ul className="space-y-2 leading-relaxed">
                    <li><Link href="/menifee" className="text-[#CD7B00] font-medium hover:text-white">Menifee</Link></li>
          ...
          <div className="border-t border-gray-700 mt-16 pt-10">
            ...
            <div className="text-center text-xs text-gray-500"><p>© {new Date().getFullYear()} Senior Care Authority - Menifee. All rights reserved.</p></div>
          </div>
        </div>
      </footer>
    </div>
