...
const rialtoHomes = [
  { title: "Comfort Care Homes", description: "Welcoming residential care facilities in Rialto offering personalized attention in comfortable, home-like settings." },
  { title: "Full-Service Communities", description: "Comprehensive assisted living with 24/7 professional support, modern amenities, and daily activities." },
  { title: "Memory Care Specialists", description: "Secure, nurturing environments designed for seniors with Alzheimer's or dementia, staffed by trained professionals." },
  { title: "Independent Living Plus", description: "Perfect for active seniors seeking minimal assistance while enjoying community and social connections." },
];

const rialtoServices = [
...
const whyChooseRialto = [
  "Affordable quality care in San Bernardino County",
  "Central location with easy healthcare access",
  "Personalized attention with low staff ratios",
  "Close-knit community atmosphere",
  "Diverse care options for all needs",
  "Family-focused approach to senior care",
];

const rialtoTestimonials = [
  { quote: "We found excellent, affordable care in Rialto. The staff treats my mother with such kindness and respect.", name: "Carmen G.", relation: "Daughter of Rialto Resident" },
  { quote: "The personalized attention my father receives is outstanding. They truly understand his needs.", name: "John M.", relation: "Son of Resident" },
  { quote: "From the first visit, we knew this was the right place. The community feels like an extended family.", name: "Lisa P.", relation: "Rialto Family Member" }
];

const rialtoFaqs = [
  { q: "What senior care options are available in Rialto?", a: "Rialto offers various options through our network including residential care homes, assisted living communities, and specialized memory care facilities." },
  { q: "Is senior care in Rialto affordable?", a: "Yes, Rialto provides quality senior care at competitive prices, making it an excellent choice for families seeking value." },
  { q: "Do you offer memory care in Rialto?", a: "Yes, several partner homes in Rialto specialize in memory care with secure environments and trained staff." },
  { q: "How do I find the right care home?", a: "Contact us for a free consultation. We'll discuss your loved one's needs and arrange tours at matching facilities." },
  { q: "Can care plans change over time?", a: "Absolutely. Our network allows seamless transitions between care levels as needs evolve." },
  { q: "Can I tour facilities first?", a: "Yes! We encourage facility tours. Schedule a Free Tour or Call Now to begin." },
];
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white text-gray-700 overflow-x-hidden antialiased">
              ...
              <div className="relative group">
                ...
                <div className="absolute left-1/2 -translate-x-1/2 mt-7 w-[560px] bg-white rounded-md shadow-lg pt-4 pb-3 px-5 z-20 hidden group-hover:block ring-1 ring-black ring-opacity-5 before:content-[''] before:absolute before:top-[-28px] before:left-0 before:right-0 before:h-[28px]">
                  <div className="grid grid-cols-3 gap-x-6 gap-y-1">
                    ...
                    <Link href="/rialto" className="block whitespace-nowrap px-3 py-2 text-sm text-[#CD7B00] bg-gray-50 rounded">Rialto</Link>
      ...
      <section className="relative min-h-[60vh] md:min-h-[500px] flex items-center justify-center text-center overflow-hidden bg-gray-900">
        <div className="absolute inset-0"><Image src="/rialtohero.webp" alt="Rialto California community" fill style={{ objectFit: 'cover' }} className="w-full h-full object-cover opacity-50" priority /><div className="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-black/10"></div></div>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-20 md:py-28">
          <Badge className="bg-white/10 border border-white/20 text-white backdrop-blur-sm mb-4 px-3 py-1 font-medium tracking-wide text-sm rounded-full">Assisted Living in Rialto, CA</Badge>
          <h1 className="text-4xl md:text-5xl lg:text-5xl font-bold mb-4 leading-tight text-white [text-shadow:_0_1px_3px_rgb(0_0_0_/_50%)]">Quality Affordable Senior Care in Rialto, California</h1>
          <p className="text-lg md:text-xl text-white/95 leading-relaxed max-w-2xl mx-auto mb-8 [text-shadow:_0_1px_2px_rgb(0_0_0_/_40%)]">Discover compassionate assisted living in Rialto. Our care network provides personalized support at affordable prices in a welcoming community setting.</p>
      ...
      <section className="py-24 md:py-32 bg-white">
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-3 gap-12 md:gap-16 items-center">
          <div className="md:col-span-2">
            <Badge className="bg-[#CD7B00]/10 text-[#B56D00] border border-[#CD7B00]/20 mb-4 px-4 py-1 font-medium tracking-wide text-sm rounded-full">Rialto Senior Living</Badge>
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 tracking-tight">Trusted Assisted Living Services in Rialto, California</h2>
            <p className="text-lg text-gray-600 mb-6 leading-relaxed">Rialto, centrally located in San Bernardino County, offers seniors access to quality care at affordable prices. Our network of licensed care homes provides compassionate, personalized support in comfortable residential settings.</p>
            <p className="text-lg text-gray-600 mb-8 leading-relaxed">From daily assistance to specialized memory care, our Rialto communities deliver care plans tailored to each resident's unique needs and preferences.</p>
            <h3 className="text-xl font-semibold text-gray-800 mb-4">Why Choose Rialto:</h3>
            <div className="grid sm:grid-cols-2 gap-x-6 gap-y-2 text-gray-600 mb-8 text-sm">
              <ul className="space-y-2">
                <li className="flex items-start"><CheckCircle2 className="h-4 w-4 text-[#CD7B00]/80 mr-2 mt-0.5 flex-shrink-0" /> Affordable quality care</li>
                <li className="flex items-start"><CheckCircle2 className="h-4 w-4 text-[#CD7B00]/80 mr-2 mt-0.5 flex-shrink-0" /> Central Inland Empire location</li>
                ...
                <li className="flex items-start"><CheckCircle2 className="h-4 w-4 text-[#CD7B00]/80 mr-2 mt-0.5 flex-shrink-0" /> Home-cooked meals</li>
              </ul>
              <ul className="space-y-2">
                ...
                <li className="flex items-start"><CheckCircle2 className="h-4 w-4 text-[#CD7B00]/80 mr-2 mt-0.5 flex-shrink-0" /> Social activities</li>
                <li className="flex items-start"><CheckCircle2 className="h-4 w-4 text-[#CD7B00]/80 mr-2 mt-0.5 flex-shrink-0" /> Close to medical centers</li>
              </ul>
            </div>
            <Card className="bg-[#FDF8F2]/60 p-6 border border-gray-100/80 rounded-lg shadow-sm"><blockquote className="text-gray-700 italic text-center md:text-left">"We found excellent, affordable care in Rialto. The staff treats my mother with such kindness and respect."<cite className="block text-sm text-gray-500 not-italic mt-2">— Carmen G., Daughter of Rialto Resident</cite></blockquote></Card>
          </div>
          <div className="relative w-full h-80 md:h-[450px] rounded-xl overflow-hidden shadow-xl border border-gray-100/80"><Image src="/rialtopersonalizedcare.webp" alt="Rialto senior care community" fill style={{ objectFit: 'cover' }} className="transition-transform duration-500 hover:scale-105" /></div>
        </div>
      </section>

      <section id="homes" className="py-24 md:py-32 bg-[#FDF8F2]/50 border-y border-gray-100/80">
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16"><Badge className="bg-white border border-[#CD7B00]/20 text-[#B56D00] mb-6 px-4 py-1 font-medium tracking-wide text-sm rounded-full">Rialto Care Options</Badge><h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-5 tracking-tight">Senior Care Communities in Rialto</h2><p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">Explore our selection of care homes in Rialto, each offering quality services and comfortable environments.</p></div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">{rialtoHomes.map((home) => (<Card key={home.title} className="bg-white p-6 shadow-lg border border-gray-100/80 rounded-xl text-center hover:shadow-xl transition-shadow duration-300 flex flex-col"><CardHeader className="p-0 mb-3 flex-shrink-0"><CardTitle className="text-xl font-semibold text-gray-800">{home.title}</CardTitle></CardHeader><CardContent className="p-0 flex-grow"><p className="text-sm text-gray-600 leading-relaxed">{home.description}</p></CardContent></Card>))}</div>
      ...
      <section id="team" className="py-24 md:py-32 bg-white">
        <div className="max-w-screen-lg mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20"><Badge className="bg-[#CD7B00]/10 text-[#B56D00] border border-[#CD7B00]/20 mb-6 px-4 py-1 font-medium tracking-wide text-sm rounded-full">Our Team</Badge><h2 className="text-3xl md:text-4xl font-bold mb-5 text-gray-900 tracking-tight">Your Rialto Senior Care Team</h2><p className="text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">Our experienced team guides Rialto families through senior care decisions with expertise and compassion.</p></div>
      ...
      <section id="services" className="py-24 md:py-32 bg-[#FDF8F2]/50 border-t border-gray-100/80">
        <div className="max-w-screen-lg mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-12 md:gap-16 items-center">
          <div className="relative w-full h-80 md:h-96 rounded-xl overflow-hidden shadow-xl border border-gray-100/80 order-last md:order-first"><Image src="/rialtoourservices.webp" alt="Senior services in Rialto" fill style={{ objectFit: 'cover' }} className="transition-transform duration-500 hover:scale-105" /></div>
          <div><Badge className="bg-white border border-[#CD7B00]/20 text-[#B56D00] mb-4 px-4 py-1 font-medium tracking-wide text-sm rounded-full">Our Services</Badge><h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 tracking-tight">Senior Care Services in Rialto</h2><p className="text-lg text-gray-600 mb-8 leading-relaxed">Our Rialto care homes provide comprehensive services tailored to each resident's unique needs.</p><h3 className="text-xl font-semibold text-gray-800 mb-4">Services Include:</h3><div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-2 text-gray-600 mb-8 text-sm">{rialtoServices.map(service => (<div key={service} className="flex items-start"><CheckCircle2 className="h-4 w-4 text-[#CD7B00]/80 mr-2 mt-0.5 flex-shrink-0" />{service}</div>))}</div><Button asChild size="lg" className="bg-[#CD7B00] hover:bg-[#B56D00] text-white shadow-md hover:shadow-lg transition-shadow duration-300 px-7 py-3 text-base rounded-md"><a href="tel:951-299-9962"><Phone className="mr-2 h-5 w-5" /> Discuss Care Needs</a></Button></div>
        </div>
      </section>

      <section id="why-us" className="py-24 md:py-32 bg-white border-b border-gray-100/80">
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16"><Badge className="bg-[#CD7B00]/10 text-[#B56D00] border border-[#CD7B00]/20 mb-6 px-4 py-1 font-medium tracking-wide text-sm rounded-full">Why Choose Rialto</Badge><h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-5 tracking-tight">Rialto's Trusted Senior Care Partner</h2><p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">Families throughout Rialto trust us for affordable, quality senior care.</p></div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">{whyChooseRialto.map((reason, index) => (<Card key={index} className="bg-white p-6 shadow-lg border border-gray-100/80 rounded-xl"><div className="flex items-start gap-4"><div className="h-10 w-10 bg-[#FDF8F2] rounded-lg flex items-center justify-center flex-shrink-0 border border-gray-100/80 mt-1"><Star className="h-5 w-5 text-[#CD7B00]" /></div><p className="text-sm leading-relaxed text-gray-700">{reason}</p></div></Card>))}</div>
        </div>
      </section>

      <section id="testimonials" className="relative py-24 md:py-32 border-b border-gray-100/80 bg-cover bg-center bg-no-repeat" style={{ backgroundImage: "url('/rialtotestimonials.webp')" }}>
        <div className="absolute inset-0 bg-white/80" aria-hidden="true" />
        <div className="relative z-10 max-w-screen-lg mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16"><Badge className="bg-white border border-[#CD7B00]/20 text-[#B56D00] mb-6 px-4 py-1 font-medium tracking-wide text-sm rounded-full">Testimonials</Badge><h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-5 tracking-tight">What Rialto Families Say</h2></div>
          <div className="grid md:grid-cols-1 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">{rialtoTestimonials.map((item, index) => (<Card key={index} className="bg-white p-8 shadow-xl border border-gray-100/80 rounded-xl"><div className="flex flex-col items-center text-center"><Quote className="h-8 w-8 text-[#CD7B00]/40 mb-5" /><blockquote className="text-gray-600 leading-relaxed text-base italic mb-6 font-serif flex-grow">"{item.quote}"</blockquote><h3 className="text-lg font-semibold mb-1 text-gray-800">{item.name}</h3><p className="text-sm text-[#CD7B00] font-medium">{item.relation}</p></div></Card>))}</div>
        </div>
      </section>

      <section id="faq" className="py-24 md:py-32 bg-white border-b border-gray-100/80">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16"><Badge className="bg-[#CD7B00]/10 text-[#B56D00] border border-[#CD7B00]/20 mb-6 px-4 py-1 font-medium tracking-wide text-sm rounded-full">FAQs</Badge><h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-5 tracking-tight">Rialto Senior Care FAQs</h2><p className="text-lg text-gray-600 leading-relaxed">Common questions about assisted living in Rialto, California.</p></div>
          <Accordion type="single" collapsible className="space-y-4">{rialtoFaqs.map((faq, index) => (<AccordionItem key={index} value={`item-${index + 1}`} className="bg-white border border-gray-200/80 rounded-lg px-6 shadow-sm hover:shadow-md transition-all duration-300 data-[state=open]:border-[#CD7B00]/40 data-[state=open]:shadow-lg"><AccordionTrigger className="hover:text-[#CD7B00] py-4 transition-colors text-left text-base font-medium text-gray-800 data-[state=open]:text-[#CD7B00] hover:no-underline [&[data-state=open]>svg]:text-[#CD7B00]">{faq.q}</AccordionTrigger><AccordionContent className="text-gray-600 leading-relaxed pb-5 text-sm pt-0">{faq.a}</AccordionContent></AccordionItem>))}</Accordion>
        </div>
      </section>
      ...
      <section id="contact" className="py-24 md:py-32 bg-[#FDF8F2]/50 border-b border-gray-100/80">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 tracking-tight">Find Affordable Senior Care in Rialto Today</h2>
          <p className="text-lg text-gray-600 mb-10 leading-relaxed max-w-2xl mx-auto">Ready to explore senior care options in Rialto? Contact us for a free consultation.</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button asChild size="lg" className="bg-[#CD7B00] hover:bg-[#B56D00] text-white shadow-md hover:shadow-lg transition-shadow duration-300 px-7 py-3 text-base rounded-md"><a href="tel:951-299-9962"><Phone className="mr-2 h-5 w-5" /> Call (951) 299-9962</a></Button>
        ...
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16">
            <div className="lg:col-span-2 space-y-5">
              ...
              <div className="flex items-start gap-2 text-gray-400 text-sm"><MapPin className="h-4 w-4 text-[#CD7B00] mt-0.5 flex-shrink-0" /><span>Serving Rialto, Fontana, San Bernardino & the Inland Empire</span></div>
            ...
            <div className="lg:col-span-3">
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-8 text-sm">
                <div><h4 className="text-white mb-4 font-semibold text-sm tracking-wide uppercase">Locations</h4><ul className="space-y-2 leading-relaxed"><li><Link href="/rialto" className="text-[#CD7B00] font-medium hover:text-white">Rialto</Link></li><li><Link href="/fontana" className="hover:text-white">Fontana</Link></li><li><Link href="/san-bernardino" className="hover:text-white">San Bernardino</Link></li><li><Link href="/ontario" className="hover:text-white">Ontario</Link></li></ul></div>
          ...
          <div className="border-t border-gray-700 mt-16 pt-10">
            ...
            <div className="text-center text-xs text-gray-500"><p>© {new Date().getFullYear()} Senior Care Authority - Rialto. All rights reserved.</p></div>
          </div>
        </div>
      </footer>
    </div>
