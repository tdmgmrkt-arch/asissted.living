...
const indioHomes = [
  { title: "Desert Valley Homes", description: "Welcoming senior residences offering personalized care in Indio's warm, sunny climate with comfortable accommodations." },
  { title: "Premier Care Communities", description: "Full-service assisted living with modern amenities, engaging activities, and professional staff available around the clock." },
  { title: "Specialized Memory Care", description: "Secure, nurturing environments designed for seniors living with Alzheimer's disease or other forms of dementia." },
  { title: "Independent Living Plus", description: "Ideal for active seniors who want minimal assistance while enjoying community living and social connections." },
];

const indioServices = [
  "Daily living assistance (bathing, dressing, mobility)",
...
const whyChooseIndio = [
  "Variety of care homes throughout Indio and eastern Coachella Valley",
  "Personalized care with low resident-to-caregiver ratios",
  "Affordable options without compromising quality",
  "Experienced, licensed caregivers with ongoing training",
  "Warm, family-oriented home environments",
  "Strong relationships with local healthcare providers",
];

const indioTestimonials = [
  { quote: "The team helped us find an affordable home in Indio that exceeded our expectations. Dad is thriving there.", name: "Maria L.", relation: "Daughter of Indio Resident" },
  { quote: "We appreciated the honest guidance throughout our search. They truly care about matching families with the right home.", name: "James R.", relation: "Indio Family Member" },
  { quote: "The caregivers treat my mother like their own family. We couldn't ask for better care.", name: "Susan T.", relation: "Daughter of Resident" }
];

const indioFaqs = [
  { q: "What senior care options are available in Indio?", a: "We work with multiple licensed residential care homes in Indio offering varying levels of assistance, from light support to comprehensive memory care." },
  { q: "Is assisted living in Indio affordable?", a: "Yes, Indio offers some of the most affordable assisted living options in the Coachella Valley. We help families find quality care within their budget." },
  { q: "Do you offer memory care services in Indio?", a: "Yes, several of our partner homes specialize in memory care with secure environments and staff trained in dementia care techniques." },
  { q: "How do I start the search process?", a: "Contact us for a free consultation. We'll discuss your loved one's needs and schedule tours at homes that match your requirements." },
  { q: "Can care plans be adjusted over time?", a: "Absolutely. Our network allows for seamless transitions as care needs change, ensuring continuous quality care." },
  { q: "Are facility tours available?", a: "Yes! We encourage families to tour homes before making a decision. Schedule a Free Tour or Call Now to get started." },
];

export default function IndioPage() {
    ...
    <div className="flex flex-col min-h-screen bg-white text-gray-700 overflow-x-hidden antialiased">
            ...
            <nav className="hidden md:flex items-center space-x-8 lg:space-x-10 text-sm font-medium">
              ...
              <div className="relative group">
                <button className="flex items-center space-x-1 text-gray-600 hover:text-[#CD7B00] transition-colors duration-200 text-sm font-medium">
                  <span>Locations</span>
                  <svg className="w-4 h-4 fill-current text-gray-400 group-hover:text-[#CD7B00]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                ...
                <div className="absolute left-1/2 -translate-x-1/2 mt-7 w-[560px] bg-white rounded-md shadow-lg pt-4 pb-3 px-5 z-20 hidden group-hover:block ring-1 ring-black ring-opacity-5 before:content-[''] before:absolute before:top-[-28px] before:left-0 before:right-0 before:h-[28px]">
                  <div className="grid grid-cols-3 gap-x-6 gap-y-1">
                    ...
                    <Link href="/indio" className="block whitespace-nowrap px-3 py-2 text-sm text-[#CD7B00] bg-gray-50 rounded">Indio</Link>
      ...
      <section className="relative min-h-[60vh] md:min-h-[500px] flex items-center justify-center text-center overflow-hidden bg-gray-900">
        <div className="absolute inset-0">
          <Image src="/indiohero.webp" alt="Indio California senior care community in the desert" fill style={{ objectFit: 'cover' }} className="w-full h-full object-cover opacity-50" priority />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-20 md:py-28">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-5xl font-bold mb-4 leading-tight text-white [text-shadow:_0_1px_3px_rgb(0_0_0_/_50%)]">
            Affordable Quality Senior Care in Indio, California
          </h1>
          <p className="text-lg md:text-xl text-white/95 leading-relaxed max-w-2xl mx-auto mb-8 [text-shadow:_0_1px_2px_rgb(0_0_0_/_40%)]">
            Discover compassionate, affordable assisted living in Indio. Our network of licensed homes provides personalized care while honoring your loved one's independence and dignity.
          </p>
      ...
      <section className="py-24 md:py-32 bg-white">
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-3 gap-12 md:gap-16 items-center">
          <div className="md:col-span-2">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 tracking-tight">Quality Assisted Living Services in Indio, California</h2>
            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
              Indio, known as the "City of Festivals," offers a welcoming environment for seniors seeking quality care at affordable prices. Our network of licensed residential care homes provides the perfect blend of professional support and hometown warmth.
            </p>
            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
              Whether your loved one needs help with daily activities or specialized memory care, our Indio communities deliver compassionate, personalized care plans designed around individual needs.
            </p>
            <h3 className="text-xl font-semibold text-gray-800 mb-4">Why Families Choose Indio:</h3>
            <div className="grid sm:grid-cols-2 gap-x-6 gap-y-2 text-gray-600 mb-8 text-sm">
              <ul className="space-y-2">
                ...
                <li className="flex items-start"><CheckCircle2 className="h-4 w-4 text-[#CD7B00]/80 mr-2 mt-0.5 flex-shrink-0" /> Warm desert climate year-round</li>
            ...
            <Card className="bg-[#FDF8F2]/60 p-6 border border-gray-100/80 rounded-lg shadow-sm">
              <blockquote className="text-gray-700 italic text-center md:text-left">
                "The team helped us find an affordable home in Indio that exceeded our expectations. Dad is thriving there."
                <cite className="block text-sm text-gray-500 not-italic mt-2">— Maria L., Daughter of Indio Resident</cite>
              </blockquote>
            </Card>
          </div>
          <div className="relative w-full h-80 md:h-[450px] rounded-xl overflow-hidden shadow-xl border border-gray-100/80">
            <Image src="/indiopersonalizedcare.webp" alt="Indio assisted living community" fill style={{ objectFit: 'cover' }} className="transition-transform duration-500 hover:scale-105" />
          </div>
        </div>
      </section>
      ...
      <section id="homes" className="py-24 md:py-32 bg-[#FDF8F2]/50 border-y border-gray-100/80">
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-5 tracking-tight">Senior Care Communities in Indio</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Explore our network of quality care homes in Indio, each offering unique features and care levels to match your family's needs.
            </p>
          </div>
      ...
      <section id="team" className="py-24 md:py-32 bg-white">
        <div className="max-w-screen-lg mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-5 text-gray-900 tracking-tight">Your Indio Senior Care Advisors</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">Our experienced team helps Indio families navigate senior care options with compassion and expertise.</p>
          </div>
      ...
      <section id="services" className="py-24 md:py-32 bg-[#FDF8F2]/50 border-t border-gray-100/80">
        <div className="max-w-screen-lg mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-12 md:gap-16 items-center">
          <div className="relative w-full h-80 md:h-96 rounded-xl overflow-hidden shadow-xl border border-gray-100/80 order-last md:order-first">
            <Image src="/indioourservices.webp" alt="Senior care services in Indio" fill style={{ objectFit: 'cover' }} className="transition-transform duration-500 hover:scale-105" />
          </div>
          <div>
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 tracking-tight">Assisted Living Services in Indio</h2>
            <p className="text-lg text-gray-600 mb-8 leading-relaxed">Our Indio care homes provide comprehensive services tailored to each resident's unique needs and preferences.</p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-2 text-gray-600 mb-8 text-sm">
              {indioServices.map(service => (<div key={service} className="flex items-start"><CheckCircle2 className="h-4 w-4 text-[#CD7B00]/80 mr-2 mt-0.5 flex-shrink-0" />{service}</div>))}
            </div>
            <Button asChild size="lg" className="bg-[#CD7B00] hover:bg-[#B56D00] text-white shadow-md hover:shadow-lg transition-shadow duration-300 px-7 py-3 text-base rounded-md">
      ...
      <section id="why-us" className="py-24 md:py-32 bg-white border-b border-gray-100/80">
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <Badge className="bg-[#CD7B00]/10 text-[#B56D00] border border-[#CD7B00]/20 mb-6 px-4 py-1 font-medium tracking-wide text-sm rounded-full">Why Choose Indio</Badge>
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-5 tracking-tight">Indio's Trusted Senior Care Provider</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">Families throughout Indio and the eastern Coachella Valley trust us for quality, affordable senior care.</p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {whyChooseIndio.map((reason, index) => (
      ...
      {/* Testimonials */}
      <section id="testimonials" className="relative py-24 md:py-32 border-b border-gray-100/80 bg-cover bg-center bg-no-repeat" style={{ backgroundImage: "url('/indiotestimonials.webp')" }}>
        ...
        <div className="relative z-10 max-w-screen-lg mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-5 tracking-tight">What Indio Families Say</h2>
          </div>
          <div className="grid md:grid-cols-1 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {indioTestimonials.map((item, index) => (
      ...
      <section id="faq" className="py-24 md:py-32 bg-white border-b border-gray-100/80">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-5 tracking-tight">Indio Assisted Living Questions</h2>
            <p className="text-lg text-gray-600 leading-relaxed">Common questions about senior care options in Indio, California.</p>
          </div>
          <Accordion type="single" collapsible className="space-y-4">
            {indioFaqs.map((faq, index) => (
      ...
      <section id="contact" className="py-24 md:py-32 bg-[#FDF8F2]/50 border-b border-gray-100/80">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 tracking-tight">Find Affordable Assisted Living in Indio Today</h2>
          <p className="text-lg text-gray-600 mb-10 leading-relaxed max-w-2xl mx-auto">Let us help you find quality, affordable senior care in Indio. Contact our team for a free consultation and personalized recommendations.</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button asChild size="lg" className="bg-[#CD7B00] hover:bg-[#B56D00] text-white shadow-md hover:shadow-lg transition-shadow duration-300 px-7 py-3 text-base rounded-md">
              <a href="tel:951-299-9962"><Phone className="mr-2 h-5 w-5" /> Call (951) 299-9962</a>
            </Button>
        ...
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16">
            <div className="lg:col-span-2 space-y-5">
              ...
              <div className="flex items-start gap-2 text-gray-400 text-sm"><MapPin className="h-4 w-4 text-[#CD7B00] mt-0.5 flex-shrink-0" /><span>Serving Indio, Coachella, La Quinta & the Coachella Valley</span></div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-8 text-sm">
                <div>
                  ...
                  <ul className="space-y-2 leading-relaxed">
                    <li><Link href="/indio" className="text-[#CD7B00] font-medium hover:text-white">Indio</Link></li>
                    <li><Link href="/palm-desert" className="hover:text-white">Palm Desert</Link></li>
          ...
          <div className="border-t border-gray-700 mt-16 pt-10">
            ...
            <div className="text-center text-xs text-gray-500"><p>© {new Date().getFullYear()} Senior Care Authority - Indio. All rights reserved.</p></div>
          </div>
        </div>
      </footer>
    </div>
