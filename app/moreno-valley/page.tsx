...
const morenoValleyHomes = [
  { title: "Valley Comfort Homes", description: "Welcoming residential care homes in Moreno Valley's established neighborhoods offering attentive, personalized care." },
  { title: "Premier Care Communities", description: "Full-service assisted living with comprehensive support, modern facilities, and engaging daily activities." },
  { title: "Memory Care Specialists", description: "Dedicated memory care environments providing secure, compassionate support for Alzheimer's and dementia." },
  { title: "Independent Plus Living", description: "Ideal for active seniors wanting light assistance while maintaining independence and social connections." },
];

const morenoValleyServices = [
...
const whyChooseMorenoValley = [
  "Diverse, welcoming community with quality care options",
  "Affordable senior living in central Riverside County",
  "Low staff-to-resident ratios for personalized care",
  "Close proximity to major medical centers",
  "Family-centered care philosophy",
  "Growing healthcare infrastructure",
];

const morenoValleyTestimonials = [
  { quote: "The care team in Moreno Valley has been incredible. Mom is thriving and we have peace of mind knowing she's well cared for.", name: "Sandra H.", relation: "Daughter of Moreno Valley Resident" },
  { quote: "Affordable doesn't mean lower quality here. We found exceptional care at a price that works for our family.", name: "David L.", relation: "Son of Resident" },
  { quote: "From day one, the staff made dad feel at home. The community atmosphere is warm and welcoming.", name: "Rachel T.", relation: "Moreno Valley Family Member" }
];

const morenoValleyFaqs = [
  { q: "What senior care options exist in Moreno Valley?", a: "Moreno Valley offers various options through our network including residential care homes, assisted living communities, and specialized memory care." },
  { q: "Is Moreno Valley affordable for senior care?", a: "Yes, Moreno Valley provides quality senior care at competitive prices, making it an excellent choice for families seeking value." },
  { q: "Do you have memory care in Moreno Valley?", a: "Yes, several partner homes specialize in memory care with secure environments and trained dementia care staff." },
  { q: "How do I choose the right care home?", a: "Schedule a free consultation with our team. We'll assess needs and arrange tours at homes matching your requirements." },
  ...
  { q: "Can I tour facilities first?", a: "Yes! We encourage tours before making decisions. Schedule a Free Tour or Call Now to get started." },
];
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white text-gray-700 overflow-x-hidden antialiased">
              ...
              <div className="relative group">
                ...
                <div className="absolute left-1/2 -translate-x-1/2 mt-7 w-[560px] bg-white rounded-md shadow-lg pt-4 pb-3 px-5 z-20 hidden group-hover:block ring-1 ring-black ring-opacity-5 before:content-[''] before:absolute before:top-[-28px] before:left-0 before:right-0 before:h-[28px]">
                  <div className="grid grid-cols-3 gap-x-6 gap-y-1">
                    ...
                    <Link href="/moreno-valley" className="block whitespace-nowrap px-3 py-2 text-sm text-[#CD7B00] bg-gray-50 rounded">Moreno Valley</Link>
      ...
      <section className="relative min-h-[60vh] md:min-h-[500px] flex items-center justify-center text-center overflow-hidden bg-gray-900">
        <div className="absolute inset-0"><Image src="/morenovalleyhero.webp" alt="Moreno Valley California landscape" fill style={{ objectFit: 'cover' }} className="w-full h-full object-cover opacity-50" priority /><div className="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-black/10"></div></div>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-20 md:py-28">
          <Badge className="bg-white/10 border border-white/20 text-white backdrop-blur-sm mb-4 px-3 py-1 font-medium tracking-wide text-sm rounded-full">Assisted Living in Moreno Valley, CA</Badge>
          <h1 className="text-4xl md:text-5xl lg:text-5xl font-bold mb-4 leading-tight text-white [text-shadow:_0_1px_3px_rgb(0_0_0_/_50%)]">Compassionate Senior Care in Moreno Valley</h1>
          <p className="text-lg md:text-xl text-white/95 leading-relaxed max-w-2xl mx-auto mb-8 [text-shadow:_0_1px_2px_rgb(0_0_0_/_40%)]">Discover affordable, quality assisted living in Moreno Valley. Our network provides personalized care in a diverse, welcoming community.</p>
      ...
      <section className="py-24 md:py-32 bg-white">
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-3 gap-12 md:gap-16 items-center">
          <div className="md:col-span-2">
            <Badge className="bg-[#CD7B00]/10 text-[#B56D00] border border-[#CD7B00]/20 mb-4 px-4 py-1 font-medium tracking-wide text-sm rounded-full">Moreno Valley Senior Care</Badge>
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 tracking-tight">Professional Assisted Living Services in Moreno Valley, California</h2>
            <p className="text-lg text-gray-600 mb-6 leading-relaxed">Moreno Valley, one of Riverside County's largest cities, offers seniors a diverse, welcoming community with excellent healthcare access. Our network of licensed care homes provides compassionate, affordable care tailored to individual needs.</p>
            <p className="text-lg text-gray-600 mb-8 leading-relaxed">From basic assistance to comprehensive memory care, our Moreno Valley communities deliver personalized support that honors each resident's dignity and independence.</p>
            <h3 className="text-xl font-semibold text-gray-800 mb-4">What Sets Moreno Valley Apart:</h3>
            ...
            <Card className="bg-[#FDF8F2]/60 p-6 border border-gray-100/80 rounded-lg shadow-sm"><blockquote className="text-gray-700 italic text-center md:text-left">"The care team in Moreno Valley has been incredible. Mom is thriving and we have peace of mind."<cite className="block text-sm text-gray-500 not-italic mt-2">— Sandra H., Daughter of Moreno Valley Resident</cite></blockquote></Card>
          </div>
          <div className="relative w-full h-80 md:h-[450px] rounded-xl overflow-hidden shadow-xl border border-gray-100/80"><Image src="/morenovalleypersonalizedcare.webp" alt="Moreno Valley senior care community" fill style={{ objectFit: 'cover' }} className="transition-transform duration-500 hover:scale-105" /></div>
        </div>
      </section>
      ...
      <section id="homes" className="py-24 md:py-32 bg-[#FDF8F2]/50 border-y border-gray-100/80">
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <Badge className="bg-white border border-[#CD7B00]/20 text-[#B56D00] mb-6 px-4 py-1 font-medium tracking-wide text-sm rounded-full">Moreno Valley Options</Badge>
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-5 tracking-tight">Senior Care Communities in Moreno Valley</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">Discover quality care homes throughout Moreno Valley, each offering personalized services and comfortable environments.</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            {morenoValleyHomes.map((home) => (<Card key={home.title} className="bg-white p-6 shadow-lg border border-gray-100/80 rounded-xl text-center hover:shadow-xl transition-shadow duration-300 flex flex-col"><CardHeader className="p-0 mb-3 flex-shrink-0"><CardTitle className="text-xl font-semibold text-gray-800">{home.title}</CardTitle></CardHeader><CardContent className="p-0 flex-grow"><p className="text-sm text-gray-600 leading-relaxed">{home.description}</p></CardContent></Card>))}
          </div>
      ...
      <section id="team" className="py-24 md:py-32 bg-white">
        <div className="max-w-screen-lg mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-5 text-gray-900 tracking-tight">Your Moreno Valley Care Advisors</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">Our experienced team guides Moreno Valley families through senior care decisions with expertise and compassion.</p>
          </div>
          <div className="grid md:grid-cols-2 gap-10">
            {teamMembers.map((member) => (<Card key={member.name} className="bg-white p-6 shadow-lg border border-gray-100/80 rounded-xl flex flex-col sm:flex-row items-center sm:items-start gap-6 hover:shadow-xl transition-shadow duration-300"><Image src={member.src} alt={member.name} width={120} height={120} className="rounded-full h-28 w-28 md:h-32 md:w-32 flex-shrink-0 object-cover border-4 border-white shadow-md" /><div className="text-center sm:text-left flex-1"><h3 className="text-xl font-semibold text-gray-900">{member.name}</h3><p className="text-[#CD7B00] font-medium text-sm mb-3">{member.role}</p><p className="text-sm text-gray-600 leading-relaxed">{member.bio}</p></div></Card>))}
          </div>
        </div>
      </section>
      ...
      <section id="services" className="py-24 md:py-32 bg-[#FDF8F2]/50 border-t border-gray-100/80">
        <div className="max-w-screen-lg mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-12 md:gap-16 items-center">
          <div className="relative w-full h-80 md:h-96 rounded-xl overflow-hidden shadow-xl border border-gray-100/80 order-last md:order-first"><Image src="/morenovalleyourservices.webp" alt="Senior care services in Moreno Valley" fill style={{ objectFit: 'cover' }} className="transition-transform duration-500 hover:scale-105" /></div>
          <div>
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 tracking-tight">Senior Services in Moreno Valley</h2>
            <p className="text-lg text-gray-600 mb-8 leading-relaxed">Our Moreno Valley partners deliver comprehensive services supporting independence while ensuring safety and comfort.</p>
            <h3 className="text-xl font-semibold text-gray-800 mb-4">Services Include:</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-2 text-gray-600 mb-8 text-sm">{morenoValleyServices.map(service => (<div key={service} className="flex items-start"><CheckCircle2 className="h-4 w-4 text-[#CD7B00]/80 mr-2 mt-0.5 flex-shrink-0" />{service}</div>))}</div>
            <Button asChild size="lg" className="bg-[#CD7B00] hover:bg-[#B56D00] text-white shadow-md hover:shadow-lg transition-shadow duration-300 px-7 py-3 text-base rounded-md"><a href="tel:951-299-9962"><Phone className="mr-2 h-5 w-5" /> Discuss Care Needs</a></Button>
          </div>
        </div>
      </section>
      ...
      <section id="contact" className="py-24 md:py-32 bg-[#FDF8F2]/50 border-b border-gray-100/80">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 tracking-tight">Find Affordable Senior Care in Moreno Valley</h2>
          <p className="text-lg text-gray-600 mb-10 leading-relaxed max-w-2xl mx-auto">Ready to explore senior care options in Moreno Valley? Contact us for a free consultation today.</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button asChild size="lg" className="bg-[#CD7B00] hover:bg-[#B56D00] text-white shadow-md hover:shadow-lg transition-shadow duration-300 px-7 py-3 text-base rounded-md"><a href="tel:951-299-9962"><Phone className="mr-2 h-5 w-5" /> Call (951) 299-9962</a></Button>
        ...
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16">
            <div className="lg:col-span-2 space-y-5">
              ...
              <div className="flex items-start gap-2 text-gray-400 text-sm"><MapPin className="h-4 w-4 text-[#CD7B00] mt-0.5 flex-shrink-0" /><span>Serving Moreno Valley, Riverside, Perris & Riverside County</span></div>
            ...
            <div className="lg:col-span-3">
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-8 text-sm">
                <div><h4 className="text-white mb-4 font-semibold text-sm tracking-wide uppercase">Locations</h4><ul className="space-y-2 leading-relaxed"><li><Link href="/moreno-valley" className="text-[#CD7B00] font-medium hover:text-white">Moreno Valley</Link></li><li><Link href="/riverside" className="hover:text-white">Riverside</Link></li><li><Link href="/menifee" className="hover:text-white">Menifee</Link></li><li><Link href="/corona" className="hover:text-white">Corona</Link></li></ul></div>
          ...
          <div className="border-t border-gray-700 mt-16 pt-10">
            ...
            <div className="text-center text-xs text-gray-500"><p>© {new Date().getFullYear()} Senior Care Authority - Moreno Valley. All rights reserved.</p></div>
          </div>
        </div>
      </footer>
    </div>
